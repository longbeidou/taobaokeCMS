...
class MakeCouponShareImageService
{
  ...
  public function imageCouponInfo ($coupon)
  {
    ...
    $info['priceOrigin'] = $coupon->price;
    $info['priceNow']    = $coupon->price_now;
    $info['img']         = $coupon->image;
    $info['linkInfo']    = route('home.couponInfo', ['id'=>$coupon->id]);
    $info['couponInfo']  = $coupon->coupon_info;
