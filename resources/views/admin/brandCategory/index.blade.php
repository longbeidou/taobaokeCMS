            ...
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{ route('brandCategorys.index') }}?page_size=10">每页显示10条信息</a></li>
                        <li><a href="{{ route('brandCategorys.index') }}?page_size=15">每页显示15条信息</a></li>
                        <li><a href="{{ route('brandCategorys.index') }}?page_size=20">每页显示20条信息</a></li>
                        <li><a href="{{ route('brandCategorys.index') }}?page_size=25">每页显示25条信息</a></li>
                        <li><a href="{{ route('brandCategorys.index') }}?page_size=30">每页显示30条信息</a></li>
                    </ul>
                </div>
            </div>
            <form action="" method="post" id="couponList">
              ...
              <div class="ibox-content" style="display: block;">
                      ...
                      <table class="table table-striped table-hover table-condensed">
                          <thead>
                              <tr>
                                  <th></th>
                                  <th>排序</th>
                                  <th style="min-width:75px;">品牌分类名称</th>
                                  <th class="text-center">品牌总数</th>
                          ...
                          <tbody id="chk">
                              @include('admin.brandCategory._brandCategory_info')
                          </tbody>
                      </table>
                  ...
                  <div class="row text-center">
                      {!! $brandCategorys->appends($oldRequest)->render() !!}
                  </div>
              </div>
            </form>
        </div>
...
<script type="text/javascript">
  function submitChoice(value) {
    ...
    if (value == 1) {
      form.action = '{{ route('brandCategorys.deleteMany') }}';
