              ...
              <form action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              <input type="text" name="name" class="form-control" required placeholder="请输入要创建的品牌分类名称">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              <input type="text" name="font_icon" class="form-control" required placeholder="请输入字体图标">
                          </div>
                      </div>
                      <div class="form-group">
