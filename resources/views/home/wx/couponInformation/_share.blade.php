<div id="shareInfo" style="display: none; position: fixed; z-index: 999; width: 80%; margin-left: 10%; margin-right: 10%; top: 10%;">
  ...
  <div style="padding: 5px 20px; width: 100%; background-color: #FFFFFF; border: 1px solid #ed2a7a; border-bottom-right-radius: 30px; border-bottom-left-radius: 30px;">
    ...
    <div style="font-size: 11px; color: red; text-align: center;">
      注：若复制失败，请手动复制
    </div>
  </div>
</div>
